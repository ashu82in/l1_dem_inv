...
game_tab, tab1, tab2, tab3, tab4, tab5 = st.tabs(["🎲 Game Simulator", "Average Demand", "📊 Demand Analyzer and Histogram","Continuous Review", "🔄 Periodic Review", "Inventory Audit"  ])
